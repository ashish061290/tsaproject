<?php include('layouts/header.php');
      $projectInfo = $Base->SelectDataWithColumn("*",'project');
       ?>
        <style>
           .surgery-support-new {
         ...
         <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
             <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Projects</li> </ol>
         </nav>
         </div>
         <hr/>
        </section>
...
<h2> Projects <span class="web-clr"></span></h2>
<p></p>
</div>
</div>
</div>
...
<div class="box">
<div class="col-lg-6">
<img class="lazy" src="<?=$project['project_img']?>" data-original="<?=$project['project_img']?>" alt="project info" style="background-image: url(&quot;<?=$project['project_img']?>&quot;);">
</div>
<div class="col-lg-6 paragraph">
<h2> <?=$project['project_name']?> <span class="web-clr"><?=$project['client_name']?> </span></h2>
