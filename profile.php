<?php include('layouts/header.php');
      $profileInfo = $Base->SelectData('about_us','page_name','profile'); ?> 
       <style>
           .surgery-support-new {
         ...
         <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
             <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Profile</li> </ol>
         </nav>
         </div>
         <hr/>
        </div>
...
<h2> Profile <span class="web-clr"></span></h2>
<p></p>
</div>
</div>
</div>
