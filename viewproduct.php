<?php include('layouts/header.php');
      if(isset($_GET['catid'])){
        $productInfo = $Base->SelectDataWithColumn("*",'products','category_id='.$_GET['catid'].'');
      }  ?>
        <style>
           .surgery-support-new {
...
<h2> Products <span class="web-clr"></span></h2>
<p></p>
</div>
</div>
</div>
...
<div class="box">
<div class="col-lg-6">
<img class="lazy" src="<?=$product['product_img']?>" data-original="<?=$product['product_img']?>" alt="Tsa-project" style="background-image: url(&quot;<?=$product['product_img']?>&quot;);">
</div>
<div class="col-lg-6 paragraph">
<h2> <?=$product['product_name']?> <span class="web-clr"></span></h2>
<p><?=$product['product_ldc']?></p>
</div>
</div>
</div>
<?php } ?>
