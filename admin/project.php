            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label>Project Description<span style="color:red;">*</span></label>
                 <textarea name="project_desc" id="project_descr" class="form-control" cols="4" rows="4"></textarea>
              </div>
...
if(isset($_POST['submit'])){
  ...
  $data = array("project_name"=>$_POST['project_name'],"client_name"=>$_POST['client_name'],"project_desc"=>$_POST['project_desc'],"project_img"=>$ImageData['file_path'],"img_name"=>$ImageData['file_name'],"status"=>1);
  ...
  <?php } } else{ ?>
              <div class="alert alert-success alert-dismissible">
                ...
                Project Upload Failed, due to some problem.
              </div>
<?php } } ?>            
            <!-- /.col -->
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label>Project Description <span style="color:red;">*</span></label>
                  <textarea name="project_desc" id="project_descr" class="form-control" cols="4" rows="4"><?= $row['project_name']?></textarea>
              </div>
              <div class="form-group">
...
if(isset($_POST['update'])){
  ...
  $data = array("project_name"=>$_POST['project_name'],"client_name"=>$_POST['client_name'],"project_desc"=>$_POST['project_desc'],"project_img"=>$img_path,"img_name"=>$img_name,"status"=>1);
  if($data){
  ...
  <?php } } else{ ?>
              <div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true" onclick="window.location='project.php'">&times;</button>
                <h4><i class="icon fa fa-check"></i>Failed!</h4>
               Project Updation Failed, due to some problem.
              </div>
<?php } } ?>            
            <!-- /.col -->
          </div>
...
?>          
  ...
  <script type="text/javascript">
		...
		CKEDITOR.replace('project_descr',{
			    //width: "500px",
        	height: "200px"
