...
if(isset($_POST['submit'])){
  ...
  if($ImageData==false){ ?>
   <div class="alert alert-success alert-dismissible">
    ...
    <?php } else{
    $Insert = $Cat->CategoryInsert($data,null,null,'category');
 ...
 if($active){
  ...
  $delete =  $Base->DeleteData('category','category_id',$id);
  if($delete){
    ?>
              <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true" onclick="window.location='category.php'">&times;</button>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label>Category Cover Image<span style="color:red;">*</span></label>
                  <input type="file" name="category_cover_img" class="form-control" accept="image/*" required="true">
              </div>
              <!-- /.form-group -->
              <div class="form-group">
...
if(isset($_POST['update'])){
  ...
  $data = array("category_name"=>$category_name,"status"=>$category_status,"category_img"=>$ImageData['file_path'],"img_name"=>$ImageData['file_name']); 
   ...
   $Update = $Cat->CategoryInsert($data,$id,'category_id','category');
    if($Update == true){?>
              <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true" onclick="window.location='category.php'">&times;</button>
                <h4><i class="icon fa fa-check"></i> Success!</h4>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
              <?php $GetCategory = $Cat->GetCategory(); 
