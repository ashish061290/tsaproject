    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <ul class="treeview-menu">
		    <li><a href="profiles.php"><i class="fa fa-arrow-circle-right"></i>Profiles</a></li>
			<li><a href="quality&accrediation.php"><i class="fa fa-arrow-circle-right"></i>Quality & Accrediation</a></li>
			<li><a href="clients.php"><i class="fa fa-arrow-circle-right"></i>Clients</a></li>
			<li><a href="contactus.php"><i class="fa fa-arrow-circle-right"></i>ContactUs</a></li>
          </ul>
        </li>
