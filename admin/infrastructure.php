            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label>Infrastructure Description<span style="color:red;">*</span></label>
                 <textarea name="infrastructure_desc" id="infra_descr" class="form-control" cols="4" rows="4"></textarea>
              </div>
...
<div class="box box-default">
        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label>Infrastructure Description <span style="color:red;">*</span></label>
                  <textarea name="infrastructure_desc" id="infra_descr" class="form-control" cols="4" rows="4"><?= $row['infrastructure_desc']?></textarea>
              </div>
              <!-- /.form-group -->
             <div class="form-group">
