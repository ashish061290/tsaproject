...
$sellerInfoQ = "SELECT * FROM `o_seller` WHERE `o_seller_id`='".$id."'";
...
<!--            <a href="category.php?action=add"><button class="btn btn-danger">Add New Category</button></a>-->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
<?php
$result = $Base->SelectDataWithColumn("*",'o_seller','o_seller_payment_status=1 && o_seller_deal_setup_status=1');
